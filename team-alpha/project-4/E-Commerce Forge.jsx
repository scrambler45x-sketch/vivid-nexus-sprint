...
const PRODUCTS = [
  { id: "chef-225", name: "Forge Chef 225", cat: "Knives", icon: "knife", steel: "52100 Carbon", spec: "225mm · 148g", price: 2399, blurb: "The one knife that does everything. Full flat grind, thin behind the edge." },
  { id: "petty-120", name: "Petty 120", cat: "Knives", icon: "knife", steel: "White #2 Carbon", spec: "120mm · 62g", price: 1399, blurb: "Board work, garnish, tight peeling. Balances a hair forward of centre." },
  { id: "santoku-180", name: "Santoku 180", cat: "Knives", icon: "knife", steel: "Aogami Super", spec: "180mm · 130g", price: 2599, blurb: "Flatter profile for a push-cut. Laminated for a harder, thinner core." },
  { id: "bread-260", name: "Bread Saw 260", cat: "Knives", icon: "knife", steel: "VG-10 Stainless", spec: "260mm · 175g", price: 1649, blurb: "Offset serration cuts crust clean without crushing the crumb." },
  { id: "cleaver-200", name: "Cleaver 200", cat: "Knives", icon: "knife", steel: "52100 Carbon", spec: "200mm · 310g", price: 2199, blurb: "Weight forward for joints and squash. Not for bone — for produce." },
  { id: "skillet-8", name: "Skillet No. 8", cat: "Cookware", icon: "skillet", steel: "Cast Iron", spec: "10in · 2.6kg", price: 1199, blurb: "Pre-seasoned three times over. Gets better every year you own it." },
  { id: "sauteuse-24", name: "Sauteuse 24", cat: "Cookware", icon: "pan", steel: "Blue Carbon Steel", spec: "24cm · 1.1kg", price: 999, blurb: "Thin carbon heats fast and answers instantly. Season before first use." },
  { id: "copper-18", name: "Copper Sauce 18", cat: "Cookware", icon: "pan", steel: "90% Copper, tin-lined", spec: "18cm · 1.4kg", price: 1849, blurb: "Unmatched heat control for sauces that split if you look away." },
  ...
  { id: "end-grain", name: "End-Grain Board", cat: "Care", icon: "board", steel: "Hard Maple", spec: "45 × 30cm", price: 1099, blurb: "End-grain closes around the edge instead of dulling it." },
];
